...
fun bindImage(imageView: ImageView, imageUrl:String?){
    imageUrl?.let {
       val imgUri = imageUrl.toUri().buildUpon().scheme("https").build() // With out this line of code also works.
...
@BindingAdapter("listDataBinding")
...
fun ImageView.bindStatus(status:MarsApiStatus?){
    when(status){
        ...
        MarsApiStatus.DONE -> this.visibility = View.GONE
    }
}